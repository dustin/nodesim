function lossDistQuery(app, docid) {
    ...
    function graph(results) {
        ...
        // for a position.
        for (var i = 0; i <= results.rows[results.rows.length-1].key[1]; ++i) {
            failure_data[i] = 0;
        }
    ...
    function display(data) {
        ...
        // XXX:  Figure out how to render a template here.
        console.log(templateData);
    };

    app.db.view('indexes/counts', {
        endkey : [docid, {}],
        startkey : [docid],
        group: true,
        reduce: true,
